package com.spring.spring.aspect;
...
@Aspect
@Component
public class BookAspect implements ThrowsAdvice  {
    ...
    @Pointcut("execution(* com.spring.spring.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.spring.spring.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.spring.spring.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.spring.spring.controller.*.*(..))", 
        throwing="excep")
